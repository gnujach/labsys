            ...
            >
                <div class="grid grid-cols-1 md:grid-cols-2">
                    <div class="p-6">
                        ...
                        <hr />
                        <button
                            @click="counterStore.incrementBy(1)"
                            class="border-1 bg-lime-300 p-2 m-2 rounded-md"
                        >
                            Increment by 1
                        </button>
                        <button
                            @click="counterStore.decrementBy(1)"
                            class="border-1 bg-green-300 p-2 m-2 rounded-md"
                        >
                            Decrement by 1
                        </button>
                        <h3 class="italic">
                            Número de cambios:
                            {{ counterStore.numberOfChanges }}
                        </h3>
                    </div>
                </div>
            </div>
