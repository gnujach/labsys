                ...
                <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                    <div class="overflow-hidden sm:rounded-lg">
                        <div class="p-6 sm:px-20 lg:px-2 bg-white">
                            ...
                            >
                                <Card
                                    title="Total"
                                    :descripcion="
                                        estudios.data.estudios.length.toString()
                                    "
                                    href="#"
                                />
                                <Card
                        ...
                        <div class="flex flex-col md:flex-row">
                            ...
                            >
                                <jet-nav-link
                                    :href="route('admin.estudios/create', {})"
                                ><button
                                ...
                                <jet-nav-link
                                    :href="route('admin.estudios/createpaquete', {})"
                                ><button
                                    class="border-green-700 border bg-white rounded mr-4 w-32 mb:w-42 p-1 hover:bg-aqua transition duration-500"
                                >
                                    <div class="flex flex-row">
                        ...
                        >
                            <table class="w-full table-fixed">
                                ...
                                <tr
                                    v-for="estudio in estudios.data.estudios"
                                    :key="estudio.data.id"
                                    class="hover:bg-gray-100 focus-within:bg-gray-100"
                                    :class="[
                                        estudio.data.attributes.activo == 0
                                            ? 'text-gray-400'
                                            : '',
                                    ]"
                                >
                                    <td class="p-3 text-sm text-gray-700">
                                        ...
                                        >
                                            {{`${estudio.data.attributes.nombre}`}}
                                        </span>
                                    </td>
                                    <td class="p-3 text-sm text-gray-700">
                                        <p class="font-bold text-blue-500 hover:underline italic uppercase">
                                            {{ estudio.data.attributes.edad }}
                                        </p>
                                    </td>
                                    <td class="p-3 text-sm text-gray-700">
                                        <p class="font-bold text-blue-500 hover:underline italic uppercase">
                                            {{ estudio.data.attributes.genero }}
                                        </p>
                                    </td>
                                    <td class="p-3 text-sm text-gray-700">
                                        <div
                                        ...
                                        >
                                            ...
                                            />
                                            <jet-nav-link v-if="$page.props.auth.permissions.includes('update-estudio')"
                                                          :href="
                                                    route(
                                                        'admin.estudios/edit',
                                                        {
                                            ...
                                            />
                                            <button @click="deleteAction(estudio.data.uuid)">
                                                <XMarkIcon
                                                    class="w-5 h-5 ml-3 pointer-events-none text-black"
                                                />
                                            </button>
...
const { results } = useFuse(term, props.estudios.data.estudios, options);
...
const  buttonClickDelete = () => {
    Inertia.delete(route("admin.estudios/delete", {
        estudio: uuidDelete.value
    }))
    stateStore.exchangeDialogDelete();
}
const reset = () => {
...
const navigateResults = (event) => {
    switch (event.code) {
        ...
        case "ArrowUp":
            ...
            break;
        case "Enter":
            Inertia.get(route('admin.estudios/edit', {
                estudio: results.value[selectedIndex.value].item.data.uuid
            }));
            break;
    }
}
